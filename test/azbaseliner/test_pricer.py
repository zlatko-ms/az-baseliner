...
class TestPricing(unittest.TestCase):
    ...
    fixtureFilePricingResponse = "test/azbaseliner/fixtures/response.pricing.001.json"
    ...
    def test_004_parse_meterid_items(self) -> None:
        ...
        fixture = self.loadJsonFile(f"test/azbaseliner/fixtures/items.meterid.{meterId}.json")
